...
import com.sajidriaz.orderplatform.paymentservice.repository.OutboxRecordRepository;
...
public class OutboxWriter {
     ...
     * @param type          fully-qualified message type, e.g. {@code events.payment.authorized}
     * @param topic         concrete Kafka topic, e.g. {@code events.payment.authorized.v1}
