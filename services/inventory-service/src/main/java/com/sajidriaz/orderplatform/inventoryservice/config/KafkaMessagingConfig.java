 ...
 * follow ADR-0014 §1 (manual ack, committed only after the stock change and the
...
public class KafkaMessagingConfig {
     ...
     *
     * <p>Note what is <em>not</em> here: insufficient stock. That is a normal business outcome
     * which becomes a {@code StockReservationFailed} reply and is acknowledged as successfully
    ...
    public org.springframework.beans.factory.SmartInitializingSingleton eagerKafkaProducerInitializer(
        ...
        return () -> {
            ...
            try {
                producer.partitionsFor(PlatformTopics.EVENTS_INVENTORY_RESERVED);
     ...
     * {@code <topic>.inventory-service.DLT} (ADR-0006), with Spring's failure-metadata headers
